  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('AdminLTE')}}/dist/img/user.png" class="img-circle elevation-2" alt="User Image" style="padding-top:5px; padding-bottom:0.5rem; width:2.5rem;">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('user.test.index')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('user.test.result')}}" class="nav-link">
